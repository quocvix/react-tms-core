...
const AutocompleteBackdrop = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => {
    return <div data-slot="autocomplete-backdrop" className={cn("fixed inset-0 z-50", className)} {...props} />;
};
...
const AutocompleteRow = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => {
    return <div data-slot="autocomplete-row" className={cn("flex items-center gap-2", className)} {...props} />;
};
...
const AutocompleteItem = ({
    ...
    const { selectedValue, highlightedValue, setHighlightedValue, selectItem, registerItem, unregisterItem } = useAc();
...
const AutocompleteClear = ({ className, ...props }: React.ButtonHTMLAttributes<HTMLButtonElement>) => {
...
const AutocompleteTrigger = ({ className, ...props }: React.ButtonHTMLAttributes<HTMLButtonElement>) => {
